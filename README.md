...
- **Database**: SQL Server (local development database)
...
```json
"ConnectionStrings": {
  "DefaultConnection": "Server=localhost;Database=ContosoDb;User Id=SA;Password=YourPassword;TrustServerCertificate=True;"
}
```

Update the connection string with your SQL Server instance details:
- **Server**: Replace `localhost` with your SQL Server instance name (e.g., `SERVER_NAME`, `SERVER_NAME\SQLEXPRESS`, or `IP_ADDRESS,PORT`)
- **User Id**: SQL Server authentication username (or omit for Windows authentication: `Trusted_Connection=True`)
- **Password**: SQL Server authentication password
- **Database**: Database name (default: `ContosoDb`)
...
**Option 1: Delete the Database via SQL Server Management Studio**

- Connect to your SQL Server instance
- Right-click the `ContosoDashboard` database
- Select "Delete" and confirm
- Run the application to recreate it automatically
